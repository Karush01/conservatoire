...
class TranslationsTableSeeder extends Seeder
{
    ...
    private function pagesTranslations()
    {
        ...
        if ($page->exists) {
            $_arr = $this->arr(['images', 'title'], $page->id);
             ...
             * ```
             */
            $_arr = $this->arr(['images', 'slug'], $page->id);
            $this->trans('pt', $_arr, 'ola-mundo');

            $_arr = $this->arr(['images', 'body'], $page->id);
    ...
    private function menusTranslations()
    {
        ...
        $_item = $this->findMenuItem(__('voyager::seeders.menu_items.images'));
        if ($_item->exists) {
